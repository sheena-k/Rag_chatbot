...
from sec_secret_key import openai_api_key
...
def generate_response(prompt, texts, embeddings, chat_history):
    ...
    print(model)
    #memory = ConversationBufferMemory(memory_key="retriever", return_source_documents=True)
...
# Example usage of the updated ChatOpenAI class
#chat_instance = ChatOpenAI(api_key=openai_api_key)